...
import com.hearyet.app.core.common.extensions.getInitialDirectoryUri
import com.hearyet.app.core.common.extensions.getMediaContentUri
import com.hearyet.app.core.ui.theme.HearYetTheme
import com.hearyet.app.core.common.service.registerForSuspendActivityResult
import com.hearyet.app.feature.player.extensions.OpenDocumentAtInitialUri
...
import com.hearyet.app.feature.player.service.PlayerService
import com.hearyet.app.feature.player.service.addSubtitleTrack
import com.hearyet.app.feature.player.service.stopPlayerSession
...
class PlayerActivity : ComponentActivity() {
        ...
        setContent {
            ...
            HearYetTheme {
                    MediaPlayerScreen(
                        player = player,
                        viewModel = viewModel,
                        playerPreferences = uiState.playerPreferences ?: return@HearYetTheme,
    ...
    private suspend fun playVideo(uri: Uri) = withContext(Dispatchers.Default) {
        // FE Addendum §16 — record MEDIA_PLAYED at the media-open point.
        viewModel.recordMediaPlayed(uri)
