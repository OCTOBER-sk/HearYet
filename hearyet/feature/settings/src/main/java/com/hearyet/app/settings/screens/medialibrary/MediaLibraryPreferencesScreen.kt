package com.hearyet.app.settings.screens.medialibrary
...
import com.hearyet.app.core.model.ThumbnailGenerationStrategy
...
private fun MediaLibraryPreferencesContent(
    ...
    Scaffold(
        ...
        Column(
            ...
            SettingsSectionHeader(text = stringResource(id = R.string.media_library))
            Column(
            ...
            SettingsSectionHeader(text = stringResource(id = R.string.scan))
            Column(
                verticalArrangement = Arrangement.spacedBy(ListItemDefaults.SegmentedGap),
            ) {
                SettingsRow(
            ...
            SettingsSectionHeader(text = stringResource(id = R.string.thumbnail))
            Column(
                verticalArrangement = Arrangement.spacedBy(ListItemDefaults.SegmentedGap),
            ) {
                SettingsRow(
