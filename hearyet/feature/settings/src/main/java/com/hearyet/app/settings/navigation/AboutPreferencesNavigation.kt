...
import com.hearyet.app.settings.screens.about.AboutPreferencesScreen
import com.hearyet.app.settings.screens.about.LibrariesScreen
...
fun EntryProviderScope<NavKey>.aboutPreferencesEntry(
    ...
    entry<AboutPreferencesRoute> {
        AboutPreferencesScreen(
            ...
            onViewIntroAgain = onViewIntroAgain,
