package com.hearyet.app.settings.screens.thumbnail
...
import com.hearyet.app.core.ui.components.SingleSelectablePreference
...
private fun ThumbnailPreferencesContent(
    ...
    Scaffold(
        ...
        Column(
            ...
            SettingsSectionHeader(text = stringResource(id = R.string.thumbnail_generation_strategy))
