package com.hearyet.app.core.database

import androidx.room.Database
import androidx.room.RoomDatabase
import androidx.room.migration.Migration
import androidx.sqlite.db.SupportSQLiteDatabase
import com.hearyet.app.core.database.dao.HiddenVideoDao
import com.hearyet.app.core.database.dao.MediumStateDao
import com.hearyet.app.core.database.dao.NetworkConnectionDao
import com.hearyet.app.core.database.dao.RecentActivityDao
import com.hearyet.app.core.database.entities.HiddenVideoEntity
import com.hearyet.app.core.database.entities.MediumStateEntity
import com.hearyet.app.core.database.entities.NetworkConnectionEntity
...
abstract class MediaDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        val MIGRATION_7_8 = object : Migration(7, 8) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // FE Addendum §16 — Recent Activity table.
                db.execSQL(
                    """
